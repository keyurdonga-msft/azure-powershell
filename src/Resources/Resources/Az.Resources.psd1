...
RequiredModules = @(@{ModuleName = 'Az.Accounts'; ModuleVersion = '2.13.3'; })
...
FunctionsToExport = 'Add-AzADAppPermission', 'Add-AzADGroupMember', 
               ...
               'Remove-AzADServicePrincipal', 'Remove-AzADSpCredential', 
               'Remove-AzADUser', 'Remove-AzRoleManagementPolicy', 
               ...
               'Update-AzADGroup', 'Update-AzADServicePrincipal', 'Update-AzADUser', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''-WithSource'' parameter to ''Publish-AzBicepModule'' for publishing source with a module (currently experimental)
